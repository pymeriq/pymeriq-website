...
export const products = [
  {
    ...
    "en": {
      ...
      "description": "Bring products, orders, and customer touchpoints into one focused storefront experience. Storefront is being shaped to help SMEs build a useful online presence without unnecessary complexity.",
      "audience": "Growing businesses that want a clearer way to present products and organize digital orders.",
      "outcomes": [
        "Give customers a clear way to browse products",
        "Organize incoming orders",
        "Build a dependable digital presence"
      ]
    },
    "es": {
      "summary": "Una tienda digital práctica diseñada alrededor de la realidad diaria de negocios en crecimiento.",
      "description": "Integra productos, pedidos y puntos de contacto con clientes en una experiencia enfocada. Storefront se está diseñando para ayudar a las PYMEs a crear una presencia digital útil sin complejidad innecesaria.",
      "audience": "Negocios en crecimiento que buscan presentar productos y organizar pedidos digitales con mayor claridad.",
      "outcomes": [
        "Dar a los clientes una forma clara de explorar productos",
        "Organizar pedidos entrantes",
        "Crear una presencia digital confiable"
      ]
    }
  },
  {
    ...
    "en": {
      ...
      "description": "Warehouse is an ecosystem product focused on helping teams track inventory movement, stock levels, and warehouse activity with greater clarity.",
      "audience": "Small operational teams that need dependable visibility into stock movement and priorities.",
      "outcomes": [
        "See inventory movement and stock levels clearly",
    ...
    "es": {
      ...
      "description": "Warehouse es un producto del ecosistema enfocado en ayudar a los equipos a dar seguimiento al movimiento de inventario, los niveles de existencias y la actividad del almacén con mayor claridad.",
      ...
      "outcomes": [
        "Ver claramente el movimiento de inventario y los niveles de existencias",
  ...
  },
  {
    ...
    "en": {
      ...
      "description": "Pymeriq AP is being explored to help smaller teams organize supplier invoices, track payment obligations and due dates, coordinate approvals, and see what needs to be paid.",
      "audience": "Smaller teams that need a focused, understandable way to manage accounts payable.",
      "outcomes": [
        "Keep supplier invoices and payment obligations visible",
        "Coordinate approvals and due dates",
    ...
    "es": {
      ...
      "description": "Pymeriq AP se está explorando para ayudar a equipos pequeños a organizar facturas de proveedores, dar seguimiento a obligaciones y fechas de vencimiento, coordinar aprobaciones y ver qué pagos requieren atención.",
      "audience": "Equipos pequeños que necesitan una forma enfocada y fácil de entender para gestionar cuentas por pagar.",
      "outcomes": [
        "Mantener visibles las facturas de proveedores y las obligaciones de pago",
        "Coordinar aprobaciones y fechas de vencimiento",
        "Mejorar la visibilidad de pagos"
      ]
    }
  },
  {
    ...
    "en": {
      ...
      "description": "Codes is an ecosystem concept for creating clearer connections between products, places, and the information teams need at the right moment.",
      "audience": "Teams exploring better traceability between physical items and useful digital information.",
      "outcomes": [
        "Identify items and access their information quickly",
        "Improve traceability",
        "Make access more immediate"
      ]
    },
    "es": {
      "summary": "Códigos y etiquetas útiles que conectan operaciones físicas con información digital.",
      "description": "Codes es un concepto del ecosistema para crear conexiones más claras entre productos, lugares y la información que los equipos necesitan en el momento correcto.",
      "audience": "Equipos que exploran mejor trazabilidad entre artículos físicos e información digital útil.",
      "outcomes": [
        "Identificar artículos y acceder rápidamente a su información",
        "Mejorar trazabilidad",
        "Dar acceso más inmediato"
      ]
    }
  },
  {
    ...
    "en": {
      ...
      "description": "Expiry Alerts is a planned solution for turning important dates into useful, timely action across inventory and operational records.",
      "audience": "Businesses that manage time-sensitive inventory, records, or recurring operational dates.",
      "outcomes": [
        "See upcoming expirations before they become urgent",
        "Act before value is lost",
        "Build more consistent routines"
      ]
    },
    "es": {
      "summary": "Visibilidad oportuna de productos y registros que se acercan a fechas importantes.",
      "description": "Expiry Alerts es una solución planificada para convertir fechas importantes en acciones útiles y oportunas en inventario y registros operativos.",
      "audience": "Negocios que manejan inventario, registros o fechas operacionales sensibles al tiempo.",
      "outcomes": [
        "Ver próximos vencimientos antes de que sean urgentes",
        "Actuar antes de perder valor",
        "Crear rutinas consistentes"
      ]
    }
  },
  {
    ...
    "en": {
      ...
      "description": "PF is being developed to help people see their finances more clearly and turn that understanding into steadier everyday decisions.",
      "audience": "People who want a calmer, more understandable approach to everyday personal finance.",
      "outcomes": [
        "See the full personal finance picture clearly",
    ...
    "es": {
      ...
      "description": "PF se está desarrollando para ayudar a las personas a ver sus finanzas con mayor claridad y convertir esa comprensión en mejores decisiones cotidianas.",
      "audience": "Personas que buscan una forma más tranquila y comprensible de manejar sus finanzas personales.",
      "outcomes": [
        "Ver claramente el panorama completo de las finanzas personales",
...
export const tutorials = [
    ...
    "en": {
      ...
      "sections": [
        [
          ...
          "Choose the questions your inventory system must answer every day: what is available, where it is, and what needs attention."
        ],
        [
          "Create one naming system",
          "Agree on simple product names and identifiers that every team member can recognize and use consistently."
        ],
        [
          "Set a repeatable rhythm",
          "A small weekly review is more useful than a large cleanup that only happens when things go wrong."
        ]
      ]
    },
    "es": {
      ...
      "sections": [
        [
          "Comienza con lo que necesitas saber",
          "Elige las preguntas que tu sistema debe contestar cada día: qué hay disponible, dónde está y qué requiere atención."
        ],
        [
          "Crea un solo sistema de nombres",
          "Define nombres e identificadores simples que todo el equipo pueda reconocer y usar consistentemente."
        ],
        [
          "Establece un ritmo repetible",
          "Una revisión semanal pequeña es más útil que una limpieza grande que solo ocurre cuando algo falla."
        ]
      ]
    }
  },
  {
    ...
    "en": {
      ...
      "sections": [
        [
          "Name the friction",
          "Describe the repeated problem in plain language before evaluating any solution."
        ],
        [
          "Define a useful result",
          "Decide what should become faster, clearer, or more reliable after the tool is introduced."
        ],
        [
          "Test the daily fit",
          "Consider who will use it, when they will use it, and whether it fits the way the work actually happens."
        ]
      ]
    },
    "es": {
      ...
      "sections": [
        [
          "Nombra la fricción",
          "Describe el problema repetido en lenguaje sencillo antes de evaluar cualquier solución."
        ],
        [
          "Define un resultado útil",
          "Decide qué debe ser más rápido, claro o confiable después de introducir la herramienta."
        ],
        [
          "Evalúa su uso diario",
          "Considera quién la usará, cuándo y si encaja con la forma en que el trabajo realmente ocurre."
        ]
      ]
    }
  },
  {
    ...
    "en": {
      ...
      "sections": [
        [
          "Choose one weekly moment",
          "Pick a time you can protect and make it the default moment for reviewing your finances."
        ],
        [
          "Review the important signals",
          "Look at balances, upcoming commitments, and unusual activity before going into individual details."
        ],
        [
          "Choose one next action",
          "End each review with one concrete action so information turns into useful progress."
        ]
      ]
    },
    "es": {
      ...
      "sections": [
        [
          "Elige un momento semanal",
          "Escoge un tiempo que puedas proteger y conviértelo en tu momento habitual para revisar tus finanzas."
        ],
        [
          "Revisa las señales importantes",
          "Observa balances, compromisos próximos y actividad inusual antes de entrar en cada detalle."
        ],
        [
          "Elige una próxima acción",
          "Termina cada revisión con una acción concreta para convertir información en progreso útil."
        ]
      ]
    }
  }
  ...
  "en": {
    ...
    "home": {
      ...
      "ctas": {
        ...
        "tutorials": "Read practical guides",
        "contact": "Start a conversation"
      },
      ...
      "whyPoints": [
        [
          "Start with reality",
          "Pay attention to how people and smaller teams actually work."
        ],
        [
          "Research the friction",
          "Look closely at what can become clearer, simpler, and more dependable."
        ],
        [
          "Build for progress",
    ...
    "cta": {
      ...
      "title": "What needs a clearer solution?"
    },
    "notFound": {
      "title": "This path is still being researched.",
      "action": "Return home"
    }
  },
  "es": {
    ...
    "home": {
      ...
      "ctas": {
        ...
        "tutorials": "Leer guías prácticas",
        "contact": "Comienza una conversación"
      },
      ...
      "proofPoints": [
        ...
        [
          "Research",
          "Mejorar mediante investigación"
        ],
        [
          "IQ",
      ...
      "satellites": {
        ...
        "learning": [
          "Aprendizaje",
          "Herramientas para conocimiento práctico"
        ]
      },
      ...
      "whyPoints": [
        [
          "Comenzar con la realidad",
          "Prestar atención a cómo realmente trabajan las personas y equipos pequeños."
        ],
        [
          "Investigar la fricción",
          "Observar qué puede ser más claro, simple y confiable."
        ],
        [
          "Crear para progresar",
    ...
    "cta": {
      ...
      "title": "¿Qué problema necesita una solución más clara?"
    },
    "notFound": {
      "title": "Esta ruta todavía está bajo investigación.",
