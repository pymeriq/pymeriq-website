...
export const products = [
  ...
  },
  {
    ...
    en: {
      ...
      description:
        "University is the learning arm of the Pymeriq ecosystem: a growing home for clear tutorials, useful frameworks, and skills that translate into action.",
      audience: "Owners, operators, and learners who value clear guidance they can put into practice.",
      outcomes: ["Build useful skills through guided practice", "Build useful capability", "Turn knowledge into action"],
    },
    es: {
      summary: "Aprendizaje práctico que ayuda a usar la tecnología y el conocimiento con confianza.",
      description:
        "University es el área educativa del ecosistema Pymeriq: un espacio en crecimiento para tutoriales claros, marcos útiles y destrezas que se convierten en acción.",
      audience: "Dueños, operadores y personas que valoran orientación clara que puedan poner en práctica.",
      outcomes: ["Desarrollar destrezas útiles mediante práctica guiada", "Desarrollar capacidades útiles", "Convertir conocimiento en acción"],
    },
  },
];
  ...
  en: {
    ...
    contact: {
      ...
      fields: {
        ...
        email: "Email",
        topic: "Topic",
        topics: ["Business Solutions", "Financial Solutions", "Learning Solutions", "Partnerships", "General inquiry"],
        message: "Message",
  ...
  es: {
    ...
    contact: {
      ...
      fields: {
        ...
        topic: "Tema",
        topics: ["Soluciones empresariales", "Soluciones financieras", "Soluciones educativas", "Colaboraciones", "Consulta general"],
        message: "Mensaje",
